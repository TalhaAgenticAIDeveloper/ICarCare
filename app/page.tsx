        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-orange-600 border-white hover:bg-orange-700 text-white px-8 py-3" asChild>
              ...
              <Button
                size="lg"
                variant="outline"
                className="bg-orange-600 border-white text-white hover:bg-white hover:text-blue-900 px-8 py-3"
              >
